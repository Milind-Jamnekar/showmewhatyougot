  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between py-24 px-12">
      ...
      <div className="flex flex-col gap-7">
        <h1 className="text-yellow-400 text-7xl text-center selection:bg-yellow-50">
          Show him what you got!
        </h1>
        <h2 className="text-yellow-200 text-center text-xl">
          Show your querkiest, weirdest or **Sighs** you modern web project here
        </h2>
      </div>
      ...
      <div
       ...
       before:h-[300px] before:w-full sm:before:w-[480px] before:-translate-x-1/2
        ...
        sm:after:w-[240px] after:translate-x-1/3 after:bg-gradient-conic
         after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-['']
          before:dark:bg-gradient-to-br before:dark:from-transparent
           before:dark:to-yellow-700 before:dark:opacity-10 after:dark:from-yellow-900
            after:dark:via-[#a16207] after:dark:opacity-40 before:lg:h-[360px] z-[-1]"
      >
        <Image
